...
echo "================================" |lolcat
echo "\033[34;1m[2. Install PrankBukalapak]" |lolcat
echo "================================" |lolcat
echo "\033[34;1m[2. Install ToolsSpam]" |lolcat
echo "================================" |lolcat
echo "\033[34;1m[2. Install Pranktelkomsel]" |lolcat
echo "================================" |lolcat
echo "\033[34;1m[2. Install Spammer-Grab]" |lolcat
echo "================================" |lolcat
...
then
clear
echo -e $green" Installing ToolsSpam "
sleep 1
pkg update && pkg upgrade
pkg install git
git clone https://github.com/sandrayoan11/ToolsSpam
echo -e $green "Done Install"
cd ToolsSpam
sh install.sh
sh gco.sh
